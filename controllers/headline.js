...
module.exports = {
  ...
  delete: function(req, res) {
    db.Headline.remove({ _id: req.params.id }).then(function(headlinedb) {
      res.json(headlinedb);
    });
  },
  // Update the specified headline
  update: function(req, res) {
    db.Headline.findOneAndUpdate({ _id: req.params.id }, { $set: req.body }, { new: true }).then(function(headlinedb) {
      res.json(headlinedb);
    });
  }
};
